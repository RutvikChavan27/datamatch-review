...
const workflowsData: Workflow[] = [
  ...
  },
  {
    ...
    description: 'Automated workflow for document upload processing and routing',
  ...
  },
  {
    ...
    description: 'Automated workflow for form submission processing and routing',
  ...
  },
  {
    ...
    description: 'Automated workflow for inventory alert processing and routing',
  ...
  },
  {
    ...
    description: 'Automated workflow for ticket creation processing and routing',
  ...
  },
  {
    ...
    description: 'Automated workflow for payment approval processing and routing',
  ...
  },
  {
    ...
    description: 'Automated workflow for regulatory compliance processing and routing',
  ...
  },
  {
    ...
    description: 'Automated workflow for vendor registration processing and routing',
  ...
  },
  {
    ...
    description: 'Automated workflow for employee onboarding processing and routing',
...
const WorkflowsList = () => {
  ...
  const getTriggerBadge = (trigger: string) => {
    ...
    return (
      <Badge 
        variant="outline"
        className={`h-6 px-2 text-xs font-medium ${triggerStyles[trigger as keyof typeof triggerStyles] || 'bg-gray-50 text-gray-700 border-gray-200'}`}
      >
        {trigger}
      </Badge>
    );
  ...
  return (
    <div className="space-y-2 px-4 pt-4 max-w-full">
      ...
      <div className="flex items-center justify-between py-1">
        <h1 className="text-xl font-semibold text-foreground font-inter">Workflows</h1>
      </div>
            ...
            <button
              ...
              className={`
                ...
                ${statusFilter === tab.key
                  ? "bg-white text-gray-900 shadow-lg shadow-black/10 border-[#C5CAD4]"
            ...
            >
              ...
              <div className={`rounded-full px-2 py-0.5 text-xs font-bold ${
                statusFilter === tab.key ? (
                  ...
                  tab.key === 'Active' ? 'bg-emerald-600 text-white' :
                  tab.key === 'Inactive' ? 'bg-gray-600 text-white' : 'bg-slate-600 text-white'
                ) : (
                  tab.key === 'all' ? 'bg-gray-100 text-gray-700' :
                  tab.key === 'Active' ? 'bg-green-100 text-gray-700' :
                  tab.key === 'Inactive' ? 'bg-gray-100 text-gray-700' : 'bg-gray-100 text-gray-700'
                )
              }`}>
                {tab.count}
              </div>
        ...
        <TabsContent value="all" className="mt-2 shadow-lg shadow-black/5">
          <Card>
            <CardContent className="p-0">
              <div className="overflow-auto h-[calc(100vh-280px)]" style={{ scrollBehavior: 'smooth' }}>
                <Table>
                  <TableHeader className="sticky top-0 z-10">
                    <TableRow className="bg-muted/50 border-b border-border hover:bg-muted/50">
                      <TableHead className="font-semibold border-r-0 text-sm text-foreground h-12 border-b sticky top-0" style={{ backgroundColor: '#ECF0F7', borderBottomColor: '#D6DEE9' }}>
                        Workflow Name
                      </TableHead>
                      <TableHead className="font-semibold border-r-0 text-sm text-foreground h-12 border-b sticky top-0" style={{ backgroundColor: '#ECF0F7', borderBottomColor: '#D6DEE9' }}>
                        Trigger
                      ...
                      <TableHead className="font-semibold border-r-0 text-sm text-foreground h-12 border-b w-12 sticky top-0" style={{ backgroundColor: '#ECF0F7', borderBottomColor: '#D6DEE9' }}>
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {paginatedWorkflows.map((workflow) => (
                      <TableRow key={workflow.id} className="h-10 hover:bg-muted/50 transition-colors">
                        <TableCell className="py-2 border-r-0">
                          <div>
                            <div className="font-medium text-sm text-foreground">{workflow.name}</div>
